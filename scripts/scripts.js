document.addEventListener('DOMContentLoaded', function () {
    const textContent = {
        es: {
            ...
            caeceTitle1: "Universidad CAECE Mar del Plata Argentina",
            swornTranslator: "Traductora Pública",
            techTranslator: "Traductora Técnico-Científica",
            caeceDates1: "Inglés - Español, 2008 - 2013",
            courses: "Cursos",
            course1: "2023: Curso Introducción a OOONA, dictado por Damián Santilli",
            course2: "2018 - 2020: Especialización en Subtitulado, niveles I y II, dictado por Damián Santilli y Mariana Acosta",
            course4: "2013: Subtitulado y Doblaje. Curso avanzado dictado por Silvina Pontrémoli",
            course3: "2014: Inglés para Traducciones Legales, dictado por Ricardo Chiessa",
            course5: "2011: III Jornadas Internacionales de Traducción e Interpretación. Disertantes: Xosé Castro Roig, Liliana Bernardita Mariotto, Damián Santilli, Mariana Costa, entre otros.",
            ...
            textsubti1: "El subtitulado es el arte y la técnica de crear versiones escritas de diálogos o comentarios que aparecen en una pantalla, usualmente películas, series, videos y otros elementos audiovisuales. Elobjetivo es convertir el contenido hablado en formato escrito, siempre conservando el contexto y elsignificado del diálogo original. Los subtítulos son esenciales para el público que consume contenido en un idioma distinto al del audio original y para personas sordas.\n El proceso de subtitulado puede dividirse en diferentes servicios que pueden pedirse por separado. El pautado, donde se crean y temporizan los subtítulos, la traducción y revisión de subtítulos, el control de calidad y ajustes, y finalmente, el pegado de subtítulos al video.",
        },
        ...
        en: {
            ...
            caeceTitle1: "CAECE University, Mar del Plata, Argentina",
